...
class Calculator:
    ...
    def bind_keys(self):
        self.window.bind("<Return>",lambda event: self.evaluate()) #pressing enter key is same as equals
    ...
    def create_equal_button(self):
        button = tk.Button(self.buttons_frame, text = "=", bg = OFF_WHITE, fg = LABEL_COLOR, font = DEFAULT_FONT_STYLE,borderwidth = 0,command = self.evaluate)
